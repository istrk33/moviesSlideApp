...
module.exports = {
     ...
     */
    async getConsts(api) {
        return await dataService.getAll(api, datastoreName);
    },
    /**
     * @param {*} api 
     */
    async createData(api) {
        const consts = {
            apiKey: "941cc48f228b",
        ...
        return await dataService.createData(api, datastoreName, { data: consts });
    },
}
